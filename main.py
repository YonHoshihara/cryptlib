...
class Application:
    '''
    class to manipulate the interface methods
    for eacth eignet need a container
    '''
    ...
    def __init__(self, master=None):
        ...
        self.lblusuario = Label(self.container6, text="Login:", font=self.fonte, width=10)
        ...
        self.bntInsert["command"] = self.insert_user
